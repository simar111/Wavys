...
const AboutUs = () => {
  ...
  return (
    <div className="bg-gray-50 text-[#1A1A1A] font-poppins">
      ...
      >
        {/* Wave Background */}
        <div className="absolute bottom-0 left-0 w-[200%] h-64 bg-repeat-x bg-[length:50%_100%] animate-wave"
          style={{
      ...
      >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-3xl font-medium max-w-4xl mx-auto text-gray-700">
            To <span className="text-[#1E90FF] font-bold">redefine</span> men's fashion with <span className="text-[#1E90FF] font-bold">bold</span>, <span className="text-[#1E90FF] font-bold">sustainable</span>, and <span className="text-[#1E90FF] font-bold">innovative</span> designs.
          </p>
        </div>
      </section>
      ...
      <section 
        ref={addToRefs}
        className="py-32 bg-gradient-to-r from-[#1E90FF] to-[#00BFFF] text-white"
      >
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold font-montserrat mb-8">Ready to Ride the Wave?</h2>
          <p className="text-xl mb-12 max-w-2xl mx-auto">
            Join thousands of men who have discovered their signature style with Wavys.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-[#00BFFF] transition-colors">Collections</a></li>
                <li><a href="#" className="hover:text-[#00BFFF] transition-colors">About Us</a></li>
                <li><a href="#" className="hover:text-[#00BFFF] transition-colors">Sustainability</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-white text-lg font-bold mb-4">Support</h3>
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-[#00BFFF] transition-colors">Contact Us</a></li>
                <li><a href="#" className="hover:text-[#00BFFF] transition-colors">FAQs</a></li>
                <li><a href="#" className="hover:text-[#00BFFF] transition-colors">Shipping</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:text-[#00BFFF] transition-colors">Cookie Preferences</a></li>
              </ul>
            </div>
          </div>
